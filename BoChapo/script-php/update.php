...
if(in_array($extension,$extensions)){
    ...
    if(isset($_POST["date_livraison"]) && isset($_POST["statut_commande"])) {
        if(!empty($_POST["date_livraison"]) && !empty($_POST["statut_commande"])) {
            $update = $connexion->prepare("UPDATE commande 
                                            SET statut_commande = ?, date_livraison = ? WHERE id_commande =?");
            $update->execute(array($_POST["statut_commande"],
